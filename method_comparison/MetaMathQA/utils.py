...
def get_git_hash(module) -> Optional[str]:
    ...
    # Cover both CPython (`site-packages`) and Debian/Colab (`dist-packages`) install layouts.
    ...
    try:
        ...
        # Not a git checkout (e.g. installed from a wheel into a non-standard location).
        return None
