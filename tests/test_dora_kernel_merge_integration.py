...
from ``kernels/dora_factored/``. When ``USE_FACTORED_DORA_KERNEL`` is enabled, the merged DoRA
weights produced by the fused kernel must match those produced by the existing dense path.
"""
